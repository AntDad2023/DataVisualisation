          ...
          <div className="flex gap-6 items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-52 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                ...
                <a href="/DataVisualisation/docs/d3-example.html" target="_blank" rel="noopener" className="block px-4 py-2.5 text-sm text-gray-600 hover:bg-blue-50 hover:text-blue-600">🔗 D3 力导向图 Demo</a>
                <a href="/DataVisualisation/docs/d3-example-race.html" target="_blank" rel="noopener" className="block px-4 py-2.5 text-sm text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-b-lg">🏁 D3 柱状图竞赛 Demo</a>
              </div>
            </div>
          </div>
        </div>
